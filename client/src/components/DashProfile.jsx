...
export default function DashProfile() {
  ...
  const [imageFileUploading, setImageFileUploading] = useState(false) // This is for waiting for upload to finish before submitting
  ...
  return (
    <div className='max-w-lg mx-auto p-3 w-full'>
      ...
      {/* Update user Success and Error msgs */}
      {updateUserSuccess && (
